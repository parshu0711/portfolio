...
const achievements = [
  {
    ...
    description: "Cleared technical interviews across three companies, contributing to three production-level industry projects.",
  },
  {
    ...
    description: (
      <>
        I have solved more than <strong className="text-white">675</strong> DSA problems on various coding platforms, participated in over <strong className="text-white">25</strong> LeetCode contests, achieved peak rating of <strong className="text-white">1639</strong>, and secured a rank in the top <strong className="text-white">18%</strong>.
      </>
    ),
  },
  {
